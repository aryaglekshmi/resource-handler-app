<template>
  <div
    ...
    v-if="!showResourceLists && !showCreateResource"
  >
  ...
  <ResourceListUsingVuex
    v-if="showResourceLists"
...
import ResourceListUsingVuex from "./resourseListsRedux.vue";
